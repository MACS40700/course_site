...
https://api.musixmatch.com/ws/1.1/album.tracks.get?album_id=20890901&apikey=8d4479eef57d783c1e73defecb105a9b

id_album <- "20890901"
apikey <- keyring::key_get("musixmatch")

getAlbumTracks<-function(id_album,apikey){
  require(jsonlite)
  data<-jsonlite::fromJSON(paste0(
    "https://api.musixmatch.com/ws/1.1/album.tracks.get?album_id=",id_album,"&apikey=",apikey))
...
hamilton_tracks <- getAlbumTracks(id_album,apikey)


```
```{r get-hamilton2, eval = FALSE, include = FALSE}
# retrieve song lyrics

    
# retrieve song lyrics
hamilton_lyrics <- hamilton_tracks %>% 
  mutate(lyrics = map(.x = track_id, getLyrics, apikey))
