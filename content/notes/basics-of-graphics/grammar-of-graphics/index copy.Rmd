---
title: "Grammar and Principles of data visualization"
output:
  html_document:
    highlight: pygments
    theme: readable
...
```{r infant-data}
infant <- read_csv(here("content", "notes", "data", "infant.csv")) %>%
...
```{r state-data}
state <- read_excel(here("content", "notes", "data","state_ideo.xlsx"))
```
...
```{r heatmap-prep}
flights <- read_csv(here("content", "notes", "data","flights-departed.csv") ) %>%
