...
Go to https://macs40700.netlify.app/for the course site. This contains the course objectives, required readings, schedules, slides, etc.
...
![Scatterplot matrix of the `Credit` dataset. Source: *An Introduction to Statistical Learning: With Applications in R*.](img/3.6.png)
...
![Fitbit dashboard. Source: me](img/fitbit-dashboard.png)
...
![Source: [The top 10 worst infographics ever created](https://klientboost.com/ppc/the-top-10-worst-infographics-ever-created/)](https://klientboost.com/wp-content/uploads/2013/05/1.jpg)
...
---
class: middle
# Getting the pieces together / background assumptions
