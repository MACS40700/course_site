...
- Final proposals due Thursday

- Clarity around Assignment #3 (sorry!)
...
---
```{r sakura-ex, echo = FALSE, warning = FALSE, out.width="45%"}
...
animate(p, nframes = 152 * 2, start_pause = 3, end_pause = 15, height = 715, width = 600)
