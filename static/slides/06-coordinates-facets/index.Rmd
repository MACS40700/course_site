...
* Coordinate systems
* Aspect ratios
* `r emo::ji("no_good_woman")` Pie charts
* Coord maps
* Themes
...
* Assignment 2 grading underway: releasing in blocks 
* Additional OH -- let me know if you want to meet and weren't able to find time!
...
ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, color = species)) + geom_point() + geom_smooth() +    scale_x_continuous(limits = c(190, 220)) + scale_y_continuous(limits = c(4000, 5000)) + labs(title = "Plot 2")
