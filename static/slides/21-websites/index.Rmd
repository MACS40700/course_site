...
1) Download sample page repo: `usethis::use_course("jmclip/jmclip.github.io")`
...
cd to place  
gh repo create YOURNAME.github.io --public  
git init 
git branch -M main  
git remote add origin https://github.com/GITHUBuserNAME/YOURNAME.github.io.git  
...
git remote add origin https://github.com/GITHUBuserNAME/jmclip-jekyll  
git push -u origin main  
